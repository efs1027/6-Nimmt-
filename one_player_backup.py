...
class computer:#電腦類別
    ...
    def select_card(self):#選擇卡片
        ...
        self.card.pop()#拔掉
        self.draw_hand(False, self.selected_card, False)
        pg.display.update()
...
def play_easy():
    ...
    while game_keep_going :
        ...
        if place_stage:#放置階段
            com1.draw_hand(False, False, False)
            com2.draw_hand(False, False, False)
            com3.draw_hand(False, False, False)
            player1.draw_hand(False, False)
